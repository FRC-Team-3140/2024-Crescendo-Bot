...
/**
 * This command class represents the intake process with movement for the L2
 * level.
 * It sets the arm to a specific angle and intake speed in parallel, then moves
 * the robot backward
 * when both are ready. Once the intake has the note, it stops the intake, stops
 * the drivetrain,
