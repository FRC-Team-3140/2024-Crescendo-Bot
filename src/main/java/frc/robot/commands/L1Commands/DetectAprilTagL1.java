...
// import frc.robot.sensors.Camera.AprilTagMeasurement;

// /**
//  * Detect the april tag
//  * 
//  * Positive yaw values mean turn the robot left. Negitive yaw values mean turn
//  * the robot right.
//  * 
...
//      * It sets up the necessary variables and assigns the tag ID based on the
//      * alliance color.
//      */
//     @Override
...
//     /**
//      * Executes the command to detect an AprilTag and update the running sum of
//      * distance and angle.
...
//             target = m_camera.getAprilTagData(tag_id);

//             if (target != null) {
//                 double ambiguity = target.ambiguity;
//                 if (ambiguity > 0.1) {
...
//                 }
//                 ;
//                 double x = target.Xdistance;
//                 double y = target.Ydistance;
...
//      */
//     public AprilTagMeasurement getTarget() {
//         return target;
//     }

//     /**
//      * Calculates and returns the average distance based on the sum of distances and
...
//     /**
//      * Returns the average yaw angle calculated from the sum of angles and the count
//      * of measurements.
//      *
...
//      * The command is considered finished if either the count exceeds 2 or the
//      * current time exceeds the end time.
//      * 
