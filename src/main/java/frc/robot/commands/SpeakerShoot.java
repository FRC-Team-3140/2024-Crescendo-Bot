...
import edu.wpi.first.wpilibj.trajectory.InterpolatingTreeMap;

public class SpeakerShoot extends Command implements Constants {

    public IntakeShooter intakeShooter; 
    private InterpolatingTreeMap<Double, Double> voltageInterpolator;

    public SpeakerShoot() {
        intakeShooter = IntakeShooter.getInstance();
        voltageInterpolator = new InterpolatingTreeMap<>(/* Add your inverseInterpolator, interpolator, and comparator here */);
    }
    ...
    public void initialize() {
        ...
        double joystickPosition = /* Get your joystick position here */;
