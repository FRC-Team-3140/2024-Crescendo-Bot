...
public interface Constants {
    ...
    public static final double maxSpeed = 5.05968; // In meters per second, determined from the free speed of the bot
                                                   // via SwerveDriveSpecialties
    ...
    public static final double maxChassisTurnSpeed = maxSpeed / botRadius; // Max Speed divided by the circumference a
                                                                           // circle determined by the distance of the
                                                                           // module from the center, divided by 2 pi to
                                                                           // convert to radians
